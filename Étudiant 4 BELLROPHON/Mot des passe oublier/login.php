...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($email) && !empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            $_SESSION['user_role'] = $user['id'] === 2 ? 'admin' : 'user';
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .forgot-link {
      ...
      font-weight: 600;
      margin-top: -14px;   /* remonte pour coller sous le champ mdp */
      margin-bottom: 20px;
      transition: color .2s;
    }
    .forgot-link:hover {
...
<body>
  ...
  <div class="login-wrapper">
    ...
    <form method="post" action="">
      ...
      <!-- ✅ Lien mot de passe oublié -->
      <a href="forgot_password.php" class="forgot-link" data-i18n="forgot-link">Mot de passe oublié ?</a>
